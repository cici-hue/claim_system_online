  ...
  return (
    <div id="dashboardPage" style={CSS_VARS}>
      {loading ? (
        <div>
          <div className="row mb-2">
            <div className="col-12 col-sm-6 col-md-4 mb-2"><SkeletonCard lines={1} /></div>
            <div className="col-12 col-sm-6 col-md-4 mb-2"><SkeletonCard lines={1} /></div>
            <div className="col-12 col-sm-6 col-md-4 mb-2"><SkeletonCard lines={1} /></div>
          </div>
          <div className="row mb-2">
          ...
          <div className="row">
            <div className="col-12 col-md-6 mb-2"><SkeletonCard lines={4} /></div>
            <div className="col-12 col-md-6 mb-2"><SkeletonCard lines={4} /></div>
          </div>
        </div>
      ) : (
      ...
      <div className="row mb-3">
        ...
        <div className="col-12 col-sm-6 col-md-4 mb-2" id="statPendingRCACard">
          <StatCard
