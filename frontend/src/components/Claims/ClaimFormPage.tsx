...
const ClaimFormPage: React.FC = () => {
  ...
  useEffect(() => {
    if (!canManageClaims()) {
      alert('You do not have permission to manage claims.')
      navigate('/claims')
    }
  ...
  const generateRiskAlertEmail = async () => {
    try {
      ...
      if (!toEmails) {
        alert('No inspector emails found for this factory agent.')
        return
      }
    ...
    <div style="font-family:'Segoe UI',system-ui,Roboto,sans-serif;color:#0f172a;max-width:620px;margin:0 auto;background:#f0f4f8;padding:20px 14px;">
      ...
      alert('Failed to generate risk alert email.')
    }
  }
  ...
  const sendRiskAlertEmail = async () => {
    ...
    try {
      ...
      alert('✅ Risk Alert email sent successfully!')
    ...
    <div>
      ...
      <form ref={formRef} onSubmit={handleSubmit} id="claimForm">
        ...
        <div style={{ background: '#fff', borderRadius: 12, padding: 24,
          ...
          {/* Row 2 */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(140px, 200px))', gap: 16 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 12, padding: 24,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(140px, 240px))', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(140px, 240px)', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(140px, 1fr))', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(140px, 1fr))', gap: 16 }}>
